...
export const About = () => {
  return (
   ...
   <Card className='w-2/4 p-6'>
        <p className='text-gray font-bold flex justify-center'>
      Industry pioneer
      ...
      <img  className="mt-8 mb-2 pl-12  max-w-screen-lg md:w-128" src="https://res.cloudinary.com/dmv3ax1yt/image/upload/v1729088573/Logo_wodfig.png" alt='app image'/>
      </Card>
    </div>
  )
}
